...
export default function Search() {
  ...
  const handleUserSearch = async (e) => {
    ...
    try {
      ...
      // GitHub returns 200 if found; otherwise throws
      setUser(data);
    } catch (err) {
  ...
  // Build advanced query string for the Search API
  function buildAdvancedQuery() {
    // Start with name/username token if provided
    const parts = [];
  ...
  return (
    <div>
      ...
      {/* Advanced search (location + min repos) */}
